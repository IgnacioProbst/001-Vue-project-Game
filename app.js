...
const app = Vue.createApp({
    ...
    computed: {
        ...
        mayUseSpecialAttack() {
            return this.counterSpecialAttack > 0;
        },
        mayUseHealth() {
            return this.counterHealth === 0;
        }
    },
    watch: {
        playerHealth(value) {
    ...
    methods: {
        startGame() {
            ...
            this.winner = null;
            this.currentRound = 0;
            this.counterHealth = 5;
            this.counterSpecialAttack = 0;
            this.logMessages = []
        },
        attackMonster() {
            this.currentRound++;
        ...
        healPlayer() {
            ...
            this.addLogMessages('Player', 'heal', healtValue);
            this.attackPlayer();
        },
        surrender() {
            this.winner = 'monster';
